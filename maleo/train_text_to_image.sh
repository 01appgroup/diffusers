...
# --train_local_data_dir=${TRAIN_LOCAL_DATA_DIR} \
# --train_tar_data_dir=${TRAIN_TAR_DATA_DIR} \
...
# --train_laion_data_dir="/ML-A100//laion2B-en/part-00048-5114fd87-297e-42b0-9d11-50f1df323dfa-c000.snappy.parquet.slice.3" \
        ...
        #         // "--train_data_dir=datasets/fengtangCCG",
        #         "--train_tar_data_dir=/ML-A100/data/multimodal_data/laion2B-en/part-00048-5114fd87-297e-42b0-9d11-50f1df323dfa-c000.snappy.parquet.slice.3",
        #         "--caption_column=additional_feature",
        #         "--use_ema",
        #         "--resolution=512",
        #         "--center_crop",
