accelerate launch --config_file test_config.yaml diffusers-xl/examples/text_to_image/train_text_to_image_sdxl.py \
--pretrained_model_name_or_path="/nfs/users/zhangsan/models/stable-diffusion-xl-base-1.0" \
--train_data_dir="/pfs/sshare/app/zhangsan/laion-high-resolution-unpack-datafile/" --caption_column=additional_feature \
